...
import com.example.familybenefitstown.res_part_rest_api.dto.repositories.LoginCodeRepository;
...
import com.example.familybenefitstown.auth_part.models.AuthTokens;
import com.example.familybenefitstown.auth_part.models.JwtUserData;
...
public class TokenCodeServiceFB implements TokenCodeService {
  ...
  public AuthTokens generateAuthTokens(String idUser) throws NotFoundException {
    ...
    if (roleEntitySet.isEmpty()) {
      throw new NotFoundException(String.format("User with ID \"%s\" not found", idUser));
    }
